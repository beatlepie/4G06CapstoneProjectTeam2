...
\begin{longtable}
 {p{0.3\textwidth} | p{0.4\textwidth} | p{0.3\textwidth}}\caption{Data Dictionary} \label{TblDataDict}\\
  \toprule
...
\begin{longtable}
 {p{0.1\textwidth} | p{0.4\textwidth} | p{0.2\textwidth} | p{0.3\textwidth}}\caption{Product Use Case} \label{TblPUC}\\
  \toprule
