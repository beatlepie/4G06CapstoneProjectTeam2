...
\subsection{Functional Requirements}
    \textbf{FR-1:} The system shall allow users to create accounts.\\
    ...
    \textbf{FR-2:} The system shall allow users to change their password.\\
    ...
    \textbf{FR-3:} The system shall allow users to add friends.\\
    ...
    \textbf{FR-4:} The system shall allow users to delete friends.\\
    ...
    \textbf{FR-5:} The system shall allow users to send text messages to other users.\\
    ...
    \textbf{FR-6:} The system shall allow users to send audio messages to other users.\\
    ...
    \textbf{FR-7:} The system shall allow users to share their location with others.\\
    ...
    \textbf{FR-8:} The system shall allow users to view events on the McMaster University campus.\\
    ...
    \textbf{FR-9:} The system shall allow users to pin events they are interested in.\\
    ...
    \textbf{FR-10:} The system shall allow users to unpin events.\\
    ...
    \textbf{FR-11:} The system shall allow users to view lecture schedule information.\\
    ...
    \textbf{FR-12:} The system shall allow users to pin lectures they are attending.\\
    ...
    \textbf{FR-13:} The system shall allow users to unpin lectures.\\
    ...
    \textbf{FR-14:} The system shall have administrator accounts that have special modification access.\\
    ...
    \textbf{FR-15:} The system shall allow users with an administrator account to add, edit, and remove events.\\
    ...
    \textbf{FR-16:} The system shall allow users with an administrator account to add, edit, and remove lectures from the schedule.\\
    ...
    \textbf{FR-17:} Each event shall be associated with a club/department, location and time.\\
    ...
    \textbf{FR-18:} Each lecture shall be associated with an instructor, location and time.\\
    ...
    \textbf{FR-19:} The system shall allow users to create a virtual avatar.\\
    ...
    \textbf{FR-20:} The system shall allow users to modify a virtual avatar.\\
    ...
    \textbf{FR-21:} The system shall recognize buildings on campus.\\
