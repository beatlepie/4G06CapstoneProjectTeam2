...
\begin{itemize}
  \item The product shall interface with the latest four major releases of iOS and Android OS (as of October 2023)
\end{itemize}
...
\begin{itemize}
  \item The product shall be downloadable through the App Store and Google Play Store
\end{itemize}
...
This product will be accessible in Android 13 and above. (???)
This product will be accessible in Windows 10 and above.
