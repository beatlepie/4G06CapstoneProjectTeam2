...
\begin{itemize}
\item The time from a successful image recognition to popup responses appearing on the user screen will be less than 3 seconds.
\item The time taken to receive a message sent by a user to the recipient will be under 2 seconds
\item The application will update the user’s shared location with their friends within 10 seconds of a location change
\end{itemize}

\subsection{Safety-Critical Requirements}

\begin{itemize}
\item The application will not collect or share any user’s location or personal data without getting permission from the user.
\item User data such as messages and location information will be securely encrypted to protect user’s privacy
\item The application will comply with all relevant privacy laws and guidelines.
\end{itemize}

\subsection{Precision or Accuracy Requirements}

\begin{itemize}
\item The product will identify the building being scanned correctly with an accuracy of at least 80%
\item The application will accurately determine the user’s location on campus within a 25m radius and display it based on their permissions.
\end{itemize}

\subsection{Robustness or Fault-Tolerance Requirements}

\begin{itemize}
\item The user will be informed in case of network connectivity issues and the application will not crash.
\item The messaging functionality will still work as planned if there is are issues collecting location information for users.
\end{itemize}

\subsection{Capacity Requirements}

\begin{itemize}
\item The finalized application will be designed to accommodate a minimum of 5,000 simultaneous users during peak hours.
\item The database will store event information for all campus buildings for at least 3 months
\end{itemize}

\subsection{Scalability or Extensibility Requirements}

\begin{itemize}
\item This product will be capable of processing about 20 people concurrently in the release build with a plan of expanding it to support all students on campus or about 40,000 people by the final version
\item This product will be capable of storing account and personal information of about 100 users in the release build with a plan of expanding it to support up to 40,000 users by the final version.
\item The application architecture will allow for the addition of new campus buildings and clubs without considerable drawbacks in performance
\end{itemize}

\subsection{Longevity Requirements}

\begin{itemize}
\item This product will be expected to operate without major malfunctions in release build for a minimum of 1 year while undergoing further development.
\item The finalized product will remain compatible with the promised operating systems and devices for a minimum of 3 years.
\end{itemize}
