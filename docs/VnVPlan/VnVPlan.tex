...
\textbf{Output/Result:} The test passes if, for all different pages, the colour scheme is the same and\
all visual elements on the screen are within the borders of the screen for all screens in the SCREEN\_VIEWPORTS list
...
and the colour scheme on each page is the same
