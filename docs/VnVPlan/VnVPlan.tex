...
\textbf{How test will be performed:} The tester will share the location with a friend, and then verify the location is visible and accurate (accuracy of 10 meters) from the other test account
