...
\textbf{Input:} All information needed to create an account (username and password)
...
\textbf{Input:} All information needed to create an account with an existing username
...
\textbf{Input:} User clicks on the delete account button
...
\textbf{Input:} Avatar and user clicks on modifying avatar button
...
\textbf{Input:} User clicks on the corresponding button of the event
...
\textbf{Input:} User clicks on the corresponding button of the lecture
...
\textbf{Input:} Sample event with name, department, time and location
...
\textbf{Input:} New event information and the admin clicks on modify event button
					
\textbf{Output:} The posted event information is changed to the new one
...
\textbf{Input:} Existing event and the admin clicks on delete event button
					
\textbf{Output:} The event is deleted and no user can see it from their end any more
...
\textbf{Input:} Sample lecture with name, instructor, time and location
...
\textbf{Input:} New lecture information and the admin clicks on modify lecture button
					
\textbf{Output:} The posted lecture information is changed to the new one
...
\textbf{Input:} Existing lecture and and the admin clicks on delete lecture button
					
\textbf{Output:} The lecture is deleted and no user can see it from their end any more
...
\textbf{How test will be performed:} Testers will install the application on different Android version (11 and above) and verify the application can start without errors, and the core features (Map, friend chatting and AR camera) have the same performance with different Android versions.

\textbf{Related Requirement(s):} OE-EPE1, OE-IAS1, MS-A1
\end{enumerate}
...
\subsection{Traceability Between Test Cases and Requirements}
	...
	\newpage
			...
			\begin{longtable}{|l|cccccccccccc|}
	\caption{Traceability Between Nonfunctional Test Cases and Nonfunctional Requirements, P-RF5 to OE-P1}                                                                                                                                                                                                                           \\
		\hline
		\textbf{Test IDs}   & \multicolumn{12}{c|}{\textbf{Nonfunctional Requirement IDs}}                                                                                                                                                                                                                 \\
		\hline
		~                   & \textbf{P-RF5}  & \textbf{P-RF6} & \textbf{P-C1} & \textbf{P-C2} & \textbf{P-SE1} & \textbf{P-SE2} & \textbf{P-SE3} & \textbf{P-L1} & \textbf{P-L2} & \textbf{OE-EPE1} & \textbf{OE-IAS1} & \textbf{OE-P1} \\
		\hline
		\textbf{NFRT-P3} & X                                                         & ~             & ~             & ~             & ~             & ~             & ~             & ~             & ~             & ~ & ~ & ~\\
		\textbf{NFRT-P5} & ~                                                         & X             & ~             & ~             & ~             & ~             & ~             & ~             & ~             & ~ & ~ & ~\\
		\textbf{NFRT-P13} & ~                                                         & ~             & ~             & X             & ~             & ~             & ~             & ~             & ~             & ~ & ~ & ~\\
